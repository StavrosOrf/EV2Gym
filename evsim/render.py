...
icons = {
    "cpo": "./evsim/icons/cpo.png",
    "transformer": "./evsim/icons/transformer.png",
    "charger_1": "./evsim/icons/charging-station_1_port.png",
    "charger_2": "./evsim/icons/charging-station_2_ports.png",
    "charger_wallbox": "./evsim/icons/charger_wallbox.png",
    "ev": "./evsim/icons/ev.png"
}
...
class Renderer():
    ...
    def __init__(self, env):
        ...
        icon = PIL.Image.open("./evsim/icons/logo.png")
