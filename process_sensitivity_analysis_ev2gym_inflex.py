...
# good one for inflexible load
file_path = './results/eval_10cs_1tr_V2GProfitPlusLoads_14_algos_2_exp_2024_07_03_505245/data.csv'
...
#convert infelxible load to percentage
data['inflexible_load'] = data['inflexible_load'] * 100

# to integer
data['inflexible_load'] = data['inflexible_load'].astype(int)
...
ax1.set_xlabel('', fontsize=labelx_fontsize)
...
ax2.set_xlabel('Maximum Inflexible Loads (%)', fontsize=labelx_fontsize)
...
ax3.set_xlabel('', fontsize=labelx_fontsize)
ax3.get_legend().remove()
# ax3.set_xticks(data['inflexible_load'].unique())


# y-axis labels
# axs[0].set_ylabel('Total Profits (€)')
# axs[0].set_xlabel('Power Limit (kW)')
# axs[0].set_xticks(data['inflexible_load'].unique())
...
# axs[1].set_xticks(data['inflexible_load'].unique())
...
# axs[2].set_xticks(data['inflexible_load'].unique())
