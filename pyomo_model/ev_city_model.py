...
class EV_City_Math_Model():
    ...
    def __init__(self, sim_file_path=None):
        ...
        print('Loading data...')
        charge_prices = replay.charge_prices
        discharge_prices = replay.discharge_prices
        port_max_power = replay.port_max_power
        port_min_power = replay.port_min_power
        ...
        ev_min_ch_power = replay.ev_min_ch_power
        ev_max_dis_power = replay.ev_max_dis_power
        ev_min_dis_power = replay.ev_min_dis_power
        u = replay.u
